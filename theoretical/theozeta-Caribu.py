...
def plot_zeta_scattering(gapfraction = 0, 
    ...
    rc = (tR, tR)  # (0.10, 0.07, 0.10, 0.07)  # Combes et al
    rs = (tFR, tFR)  # (0.41, 0.43, 0.41, 0.43)
    ...
    _, aggregated_direct = cc_scene.run(direct=False, infinite=False,
    ...
    zetas = aggregated_direct['rc']['Ei']/aggregated_direct['rs']['Ei']
